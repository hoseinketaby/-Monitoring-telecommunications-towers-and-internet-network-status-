...
const translations = {
  fa: {
    ...
    investor: 'ارزش سرمایه‌گذار',
    refreshMode: 'رفرش خودکار',
    refreshEvery: 'هر چند ثانیه',
    strategicInsights: 'خلاصه سرمایه‌گذاری',
    roi: 'ROI تخمینی',
    savings: 'صرفه‌جویی سالانه',
    avoidedOutages: 'قطعی‌های قابل پیشگیری',
    conversion: 'نرخ تبدیل دمو',
    readiness: 'آمادگی فروش',
    searchTowers: 'جست‌وجوی دکل‌ها',
    autoRefresh: 'رفرش خودکار',
    settings: 'تنظیمات',
  },
  en: {
    ...
    refreshMode: 'Auto refresh',
    refreshEvery: 'Every seconds',
    strategicInsights: 'Investor summary',
    roi: 'Estimated ROI',
    savings: 'Annual savings',
    avoidedOutages: 'Preventable outages',
    conversion: 'Demo-to-deal rate',
